...
include::cats/readme.adoc[Cat things]

include::covid-19/readme.adoc[COVID 19 things]

include::desk/readme.adoc[Desktop things]

include::duplo/readme.adoc[Lego Duplo things]

include::ender3-addon/readme.adoc[Ender 3 Addons]

include::house/readme.adoc[House stuff]

include::kite/readme.adoc[Kite Wing Cross]

include::lego/readme.adoc[Lego things]

// repairs ?

// robot ?

include::storage/readme.adoc[Storage things]

include::swimming-pool-intex/readme.adoc[Swimming Pool Things]

include::xiaomi-aqara-cr123/readme.adoc[Xiaomi Aqara on CR123A]

include::repairs/readme.adoc[Repairing models]
